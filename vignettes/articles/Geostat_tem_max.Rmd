...
-   [ ] Me cuesta encajar la sección de 2.  Exploratory Spatial Data Analysis
    que mencionabas en el correo. No está incluida de momento
...
are going to model the level of air temperature in Spain in **08 January 2021**.

We are going to download the data with with **climaemet** package in R.
...
**climaemet (\>=1.0.0)** (not released on CRAN at the time of producing this
article), so you would need to install the developing version.
...
**average daily temperature** named `tmed`.
...
## 3. Are independent the observations or they exhibit spatial dependence?

Everything is related to everything else. But near things are more related than
distant things [@tobler69].

In our study, we can observe positive spatial dependence (see \@ref(fig:choro)),
